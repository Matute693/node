...
-b = base
-l = Listar e imprimir la tabla en consola
-h = hasta que numero multiplicar

node app -b 2 -l --hasta=20

Este script genera un archivo .txt con la tabla del 2 hasta el 20
